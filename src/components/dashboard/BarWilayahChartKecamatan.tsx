    ...
    useEffect(() => {
        ...
        axios.get(url)
            .then(res => {
                ...
                // Ambil semua kecamatan dan nilai totalnya
                ...
                if (selectedKecamatan) {
                    // Ambil data per desa di kecamatan yang dipilih
                    ...
                    let desaEntries = Object.entries(desaMap);
                    desaEntries.sort((a, b) => b[1] - a[1]);
                    ...
                    // Default: tampilkan total per kecamatan
        ...
        chart: {
            ...
            events: {
                dataPointSelection: (_e: any, _ctx: any, config: any) => {
                    ...
                    if (!selectedKecamatan) {
                        // Klik kecamatan
                        sessionStorage.setItem('searchKecamatan', clicked);
                    } else {
                        // Klik desa/kelurahan di dalam kecamatan
                        sessionStorage.setItem('searchKecamatan', selectedKecamatan);
                        sessionStorage.setItem('searchDesa', clicked);
                    }
